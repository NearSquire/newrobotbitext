...
namespace robotbit {
    ...
    //% blockId=robotbit_setFreq block="setFreq|%freq"
    //% group="Motor" weight=60
    ...
    */
    ...
    export function Servo(index: Servos, degree: number): void {
        ...
        let value = v_us * 4096 / (1000000/baseFreq)
...
*/
    ...
    //% blockId=robotbit_base_Freq block="SetBaseFreq|%freq"
    //% group="Motor" weight=60
    ...
    export function StepperDegree(index: Steppers, degree: number): void {
        ...
        basic.pause((1000/baseFreq*8*64) * degree / 360);
        MotorStopAll()
    }
    ...
    export function StepperDual(degree1: number, degree2: number): void {
        ...
        basic.pause((1000 / baseFreq * 8 * 64) * Math.min(degree1, degree2) / 360);
        if (degree1 > degree2) {
            stopMotor(3); stopMotor(4);
            basic.pause((1000 / baseFreq * 8 * 64) * (degree1 - degree2) / 360);
        } else {
            stopMotor(1); stopMotor(2);
            basic.pause((1000 / baseFreq * 8 * 64) * (degree2 - degree1) / 360);
        }
    ...
    */
    ...
    export function StpCarMove(distance: number, diameter: number): void {
        ...
        let delay = (1000 / baseFreq * 8 * 64) * 10 * distance / 3 / diameter; // use 3 instead of pi
    ...
    */
    ...
    export function StpCarTurn(turn: number, diameter: number, track: number): void {
        ...
        let delay = (1000 / baseFreq * 8 * 64) * turn * track / 360 / diameter;
        setStepper(1, delay < 0);
        setStepper(2, delay > 0);
        delay = Math.abs(delay);
        basic.pause(delay);
